      ...
      projects: [
        {
          ...
          description:
            "다음 언론사 채널에 라이브 기능을 신규 추가하면서 [[‘라이브 뷰’ 프론트엔드 개발]]을 진행했습니다. 라이브 뷰는 방송되는 [[실시간 스트리밍 페이지로 동영상 플레이어, 채팅 등의 기능을 포함]]하며, 모바일/PC 환경에 최적화된 반응형 플레이어를 개발하여 사용자 경험을 향상시켰습니다.",
          whatDidIDo: [
            "MutationObserver를 활용한 메모리 효율적인 채팅 시스템을 구현했습니다. 메시지 수를 250개로 제한하고 DOM 조작을 최적화하여 대용량 실시간 채팅에서도 안정적인 성능을 보장했습니다.",
